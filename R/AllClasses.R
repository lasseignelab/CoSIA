...
setClass("CosiaAnnotate", contains = "CoSIA", slots = c(input = "character", input_species = "character", input_id = "character", output_ids = "character",
    output_species = "character", tool = "character", ortholog_database = "character", data.frame = "data.frame"), prototype = list(input = character(0),
    input_species = character(0), input_id = character(0), output_ids = character(0), output_species = character(0), tool = character(0), ortholog_database = character(0),
