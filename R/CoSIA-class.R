...
setClass("CoSIAn", contains = "CoSIA", slots = c(
    gene_set = "character", i_species = "character", input_id = "character", o_species = "character",
...
#' )
CoSIAn <- function(
    gene_set, i_species, input_id, o_species, output_ids, mapping_tool = "annotationDBI", ortholog_database = "HomoloGene",
    ...
    methods::new("CoSIAn",
        gene_set = gene_set, i_species = i_species, input_id = input_id, o_species = o_species, output_ids = output_ids,
