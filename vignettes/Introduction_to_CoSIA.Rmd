...
Test6 <- new("CosiaAnnotate", input = FullHumanMDLKD$Human_Symbol, input_species = "homo_sapiens", input_id = "SYMBOL", output_ids = c("ENSEMBL","ENTREZID"), output_species = "c_elegans", tool = "annotationDBI", ortholog_database = "NCBIOrthoAnnotationPipe")
# HomoloGene does not include C.elegans
