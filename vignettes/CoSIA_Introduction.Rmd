...
Species_user<-unique(CV_Species$Species)
for (x in 1:length(Species)){
  species_specific<-dplyr::filter(CV_Species,Species == Species_user[1])
  df_metric.wide <- tidyr::pivot_wider(species_specific, names_from = Ensembl_ID, values_from = 'CV_Species')
