...
There are three other methods for calculating and visualizing diversity and specificity `metric_type="DS_Tissue_all"`, `metric_type="DS_Gene"`, and `metric_type="DS_Gene_all"`.
...
: Table 2. CoSIA Metric Type options.
