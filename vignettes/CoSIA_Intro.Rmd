...
CoSIA::getTissues(c("h_sapiens", "r_norvegicus"))
```
...
CoSIAn_Obj_DSplot
```
<img src="../inst/images/DS_Gene_example.png" alt="Figure 3. Diversity vs Specificity of Genes in Geneset Across Anatomical Entity Names" width="703"/>
